...
{
//    vec4 color;
    float v=cnoise(floor(texCoordVarying/200)/5.0*blurAmnt);
    vec2 grid=vec2(floor((texCoordVarying.x+v*800)/(250.0+blurAmnt*200.0))*.5,floor(texCoordVarying.y/(20.0+sin(floor(texCoordVarying.y/100.0))*15.0))*10);
